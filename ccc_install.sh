...
COIN_TGZ='https://github.com/g00tch/CCC/releases/download/V2/concierged-cli.zip'
...
function create_key() {
  echo -e "${YELLOW}Press ENTER to create your ${RED}$COIN_NAME Masternode GEN Key${NC}."
  read -e COINKEY
  if [[ -z "$COINKEY" ]]; then
...
function important_information() {
 echo
 echo -e "${BLUE}================================================================================================================================${NC}"
 echo -e "${GREEN}Windows Wallet Guide: ${PURPLE}https://github.com/g00tch/CCC/blob/master/README.md${NC}"
 echo -e "${BLUE}================================================================================================================================${NC}"
 ...
 echo -e "${GREEN}concierge-cli getinfo. ${CYAN} Compare the Blocks line with the explorer to ensure the VPS is synced${NC}"
 echo -e "${GREEN}concierge-cli masternode status${NC}"
 echo -e "${BLUE}================================================================================================================================${NC}"
